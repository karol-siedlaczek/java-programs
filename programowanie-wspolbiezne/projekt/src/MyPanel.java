	...
	protected void paintComponent(Graphics g) {
		...
		for(int i = 0; i< PoruszajaceSieObiekty.wszyscy_poruszajaceSieObiekty.size(); i++){
			if(PoruszajaceSieObiekty.wszyscy_poruszajaceSieObiekty.get(i).getX()==900){
				PoruszajaceSieObiekty.czy_zajeta_lista.przechodzenie(true);
				PoruszajaceSieObiekty.wszyscy_poruszajaceSieObiekty.remove(i);
				PoruszajaceSieObiekty.czy_zajeta_lista.zwolnieniePrzejscia(true);
			}else {
